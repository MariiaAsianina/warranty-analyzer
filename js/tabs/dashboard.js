  ...
  render(container, { records, imeiAgg }) {
    ...
    container.innerHTML = `
      <div class="kpi-grid">
        ...
        ${kpiCard(k.worstOwner ? k.worstOwner.owner : "—", "Найпроблемніший власник партії", k.worstOwner ? "bad" : "", "Власник партії з найбільшою сумарною кількістю ремонтів серед своїх товарів (див. вкладку \"Власники партій\").")}
