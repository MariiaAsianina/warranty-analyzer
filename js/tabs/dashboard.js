  ...
  render(container, { records, imeiAgg }) {
    ...
    container.innerHTML = `
      <div class="kpi-grid">
        ...
        ${kpiCard(k.worstModel ? k.worstModel.model : "—", "Найпроблемніша модель", k.worstModel ? "bad" : "", "Модель з найвищим відсотком проблемних IMEI серед своїх пристроїв (див. вкладку \"Моделі\"). Враховуються лише моделі з 5+ IMEI, щоб уникнути викривлення через малу вибірку.")}
        ${kpiCard(k.worstOwner ? k.worstOwner.owner : "—", "Найпроблемніший власник партії", k.worstOwner ? "bad" : "", "Власник партії з найвищим відсотком проблемних IMEI серед своїх товарів (див. вкладку \"Власники партій\"). Враховуються лише власники з 5+ IMEI, щоб уникнути викривлення через малу вибірку.")}
